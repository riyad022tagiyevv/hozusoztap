...
async def start(bot, message):
  await message.reply_photo("https://images.app.goo.gl/a2tVMHLvoFMdv8yT9",caption=START,reply_markup=keyboard)

@Client.on_message(filters.command("help"))
async def help(bot, message):
  await message.reply_photo("https://images.app.goo.gl/a2tVMHLvoFMdv8yT9",caption=HELP) 
